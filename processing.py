...
class ProcessingSettings:
    ...
    f2_low_hz: float = 800.0
    f2_high_hz: float = 2500.0
    f3_low_hz: float = 1500.0
    f3_high_hz: float = 3500.0
    f2_weight: float = 0.6
    f3_weight: float = 0.4
...
class VoiceProcessor:
    ...
    def compute_resonance(
        ...
        f2 = formants_hz[0] if len(formants_hz) > 1 else None
        f3 = formants_hz[1] if len(formants_hz) > 2 else None
